            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <label>Nombre:</label>
                        <input id="nombre" value="<?php echo set_value('nombre') ?>" 
                        class="form-control" type="text" name="nombre" autofocus required />
                    </div>

                    <div class="col-12 col-sm-6">
                        <label>Direccion:</label>
                        <input id="direccion" value="<?php echo set_value('direccion') ?>" 
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <input id="telefono" value="<?php echo set_value('telefono') ?>" 
                        class="form-control" type="text" name="telefono"/>
                    </div>

                    <div class="col-12 col-sm-6">
                        <label>Correo:</label>
                        <input id="correo" value="<?php echo set_value('correo') ?>" 
