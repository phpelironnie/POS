...
class TemporalCompra extends BaseController
{
    ...
    //Para Agregar a la tablita paso datos pipipi
    public function cargaProductos($id_compra){ 

        $resultado = $this->temporal_compra->porCompra($id_compra);//NOS TRAE EL FOLIO
        $fila = '';
        $numFila = 0;
    ...
    //Total Agregar a la tablita products
    ...
    //Eliminar a la tablita products
